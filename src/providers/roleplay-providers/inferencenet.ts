...
export class InferenceNetProvider extends EnhancedBaseProvider<RoleplayProviderRequestParams> {
  name = 'inferencenet';
  protected baseURL = ROLEPLAY_PROVIDER_URLS.inferencenet;
  ...
  protected formatRequestBody(params: RoleplayProviderRequestParams): object {
    ...
    return {
      model: ROLEPLAY_MODELS.inferencenet,
