...
export class AvianIOProvider extends EnhancedBaseProvider<RoleplayProviderRequestParams> {
  name = 'avianio';
  protected baseURL = ROLEPLAY_PROVIDER_URLS.avianio;
