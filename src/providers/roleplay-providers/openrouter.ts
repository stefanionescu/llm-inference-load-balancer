...
export class OpenRouterProvider extends EnhancedBaseProvider<RoleplayProviderRequestParams> {
  name = 'openrouter';
  protected baseURL = ROLEPLAY_PROVIDER_URLS.openrouter;
  ...
  protected formatRequestBody(params: RoleplayProviderRequestParams): object {
    ...
    return {
      model: ROLEPLAY_MODELS.openrouter,
