...
export class AwanLLMProvider extends EnhancedBaseProvider<RoleplayProviderRequestParams> {
  name = 'awanllm';
  protected baseURL = ROLEPLAY_PROVIDER_URLS.awanllm;
