...
export class DeepInfraProvider extends EnhancedBaseProvider<RoleplayProviderRequestParams> {
  name = 'deepinfra';
  protected baseURL = ROLEPLAY_PROVIDER_URLS.deepinfra;
  ...
  protected formatRequestBody(params: RoleplayProviderRequestParams): object {
    ...
    return {
      model: ROLEPLAY_MODELS.deepinfra,
