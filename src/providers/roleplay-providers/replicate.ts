...
export class ReplicateProvider extends EnhancedBaseProvider<RoleplayProviderRequestParams> {
  name = 'replicate';
  protected baseURL = ROLEPLAY_PROVIDER_URLS.replicate;
  ...
  protected formatRequestBody(params: RoleplayProviderRequestParams): object {
    ...
    return {
      model: ROLEPLAY_MODELS.replicate,
