...
export class HyperbolicProvider extends EnhancedBaseProvider<RoleplayProviderRequestParams> {
  name = 'hyperbolic';
  protected baseURL = ROLEPLAY_PROVIDER_URLS.hyperbolic;
  ...
  protected formatRequestBody(params: RoleplayProviderRequestParams): object {
    ...
    return {
      model: ROLEPLAY_MODELS.hyperbolic,
