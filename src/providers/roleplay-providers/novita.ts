...
export class NovitaProvider extends EnhancedBaseProvider<RoleplayProviderRequestParams> {
  name = 'novita';
  protected baseURL = ROLEPLAY_PROVIDER_URLS.novita;
